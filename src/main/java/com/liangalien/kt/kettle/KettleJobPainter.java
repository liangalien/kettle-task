...
public class KettleJobPainter extends BasePainter<JobHopMeta, JobEntryCopy> {
    ...
    public KettleJobPainter( GCInterface gc, JobMeta jobMeta, Point area, ScrollBarInterface hori,
